...
test('creates a new user with a 6-charactors password', () => {
  expect(new User({ name: "hoge", password: "123456" })).toEqual({ name: "hoge", password: "123456" })
})
...
const fetchDataWithPromiseResolve = () => new Promise(resolve => setTimeout(resolve, 1000, 'lemon'))
